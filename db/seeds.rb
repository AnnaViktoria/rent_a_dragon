...
dragon = Dragon.new(user: nathan, name: 'Teostora', age: 150,price: 100 , country_of_origin: 'Iran', location: 'Yellowstone Caldera')
dragon.remote_photo_url = "https://i.redd.it/5jlzxpm1yf901.jpg"
dragon.save!

puts "Creating dragon 2"
dragon = Dragon.new(user: nicolo, name: 'Lunaria', age: 130,price: 100 , country_of_origin: 'Pakistan', location: 'Krakatoa')
dragon.remote_photo_url = "http://kojiiiima.sakura.ne.jp/WP/wp-content/uploads/2018/06/IMG_8406.jpg"
dragon.save!

puts "Creating dragon 3"
dragon = Dragon.new(user: nicolo, name: 'Toothless', age: 80 ,price: 100, country_of_origin: 'England', location: 'Isle of Man')
...
dragon = Dragon.new(user: nicolo, name: 'Death-Wing', age: 750,price: 100 , country_of_origin: 'Italy', location: 'Guantanamo Bay')
...
dragon = Dragon.new(user: marie, name: 'Thunder-Jiao-dragon', age: 100,price: 100 , country_of_origin: 'Korea', location: 'Himalayas')
...
dragon = Dragon.new(user: marie, name: 'Jiao-dragon', age: 200,price: 100 , country_of_origin: 'China', location: 'Himalayas')
dragon.remote_photo_url = "http://i.imgur.com/Emfjcm1.png"
dragon.save!

puts "Creating dragon 7"
dragon = Dragon.new(user: nathan, name: 'Kukulkan', age: 2500,price: 100 , country_of_origin: 'Peru', location: 'Machu Picchu')
dragon.remote_photo_url = "https://i2.wp.com/k61.kn3.net/taringa/9/9/2/E/D/1/harrycrosh/596.jpg"
dragon.save!

puts "Creating dragon 8"
dragon = Dragon.new(user: nathan, name: 'Leviathan', age: 3500,price: 100 , country_of_origin: 'Israel', location: 'Naples')
dragon.remote_photo_url = "https://i.pinimg.com/originals/07/f4/1a/07f41a9822512596f08cd8b0f5395975.jpg"
dragon.save!

puts "Creating dragon 9"
dragon = Dragon.new(user: marie, name: 'Kushala', age: 300,price: 100 , country_of_origin: 'England', location: 'White Cliffs of Dover')
...
dragon = Dragon.new(user: anna, name: 'Smaug', age: 450,price: 100, country_of_origin: 'New Zealand', location: 'Cappadocia')
...
dragon = Dragon.new(user: anna, name: 'Aurelion Sol', age: 50,price: 100, country_of_origin: 'United States', location: 'Gran Telescopio Canarias')
dragon.remote_photo_url = "https://hdqwalls.com/download/aurelion-sol-league-of-legends-3840x2160.jpg"
dragon.save!

puts "Creating dragon 13"
dragon = Dragon.new(user: anna, name: 'Fafnir', age: 750,price: 100, country_of_origin: 'Danemark', location: 'Randers Fjord')
...
dragon = Dragon.new(user: nathan, name: 'Safira', age: 25,price: 100, country_of_origin: 'France', location: 'Grand Rex')
