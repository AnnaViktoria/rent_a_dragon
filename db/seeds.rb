...
dragon = Dragon.new(user: nathan, name: 'Teostora', age: 150 , country_of_origin: 'Iran', location: 'Yellowstone Caldera')
...
dragon = Dragon.new(user: nicolo, name: 'Toothless', age: 80 , country_of_origin: 'England', location: 'Isle of Man')
...
dragon = Dragon.new(user: nicolo, name: 'Death-Wing', age: 750 , country_of_origin: 'Italy', location: 'Guantanamo Bay')
...
dragon = Dragon.new(user: marie, name: 'Thunder-Jiao-dragon', age: 100 , country_of_origin: 'Korea', location: 'Himalayas')
...
dragon = Dragon.new(user: nathan, name: 'Kukulkan', age: 2500 , country_of_origin: 'Peru', location: 'Machu Picchu')
dragon.remote_photo_url = "https://i2.wp.com/k61.kn3.net/taringa/9/9/2/E/D/1/harrycrosh/596.jpg"
dragon.save!

puts "Creating dragon 8"
dragon = Dragon.new(user: nathan, name: 'Leviathan', age: 3500 , country_of_origin: 'Israel', location: 'Naples')
dragon.remote_photo_url = "https://i.pinimg.com/originals/07/f4/1a/07f41a9822512596f08cd8b0f5395975.jpg"
dragon.save!

puts "Creating dragon 9"
dragon = Dragon.new(user: marie, name: 'Kushala', age: 300 , country_of_origin: 'England', location: 'White Cliffs of Dover')
...
dragon = Dragon.new(user: anna, name: 'Smaug', age: 450, country_of_origin: 'New Zealand', location: 'Cappadocia')
...
dragon = Dragon.new(user: anna, name: 'Aurelion Sol', age: 50, country_of_origin: 'United States', location: 'Gran Telescopio Canarias')
dragon.remote_photo_url = "https://hdqwalls.com/download/aurelion-sol-league-of-legends-3840x2160.jpg"
dragon.save!

puts "Creating dragon 13"
dragon = Dragon.new(user: anna, name: 'Fafnir', age: 750, country_of_origin: 'Danemark', location: 'Randers Fjord')
...
dragon = Dragon.new(user: nathan, name: 'Safira', age: 25, country_of_origin: 'France', location: 'Grand Rex')
